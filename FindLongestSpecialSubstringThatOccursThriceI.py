...
# For Weekly Contest 378 Question #2
...
s = "lkwwdddddnnnnnynnnnl"
print(maximumLength(s))

s = "cbc"
print(maximumLength(s)) 

s = "aaaffffssssooijiiqqq"
print(maximumLength(s)) 

s = "ceeeeeeeeeeeebmmmfffeeeeeeeeeeeewww"
print(maximumLength(s))

s = "hejlgbsjpedppppppdddddpphpppiiiiiga"
print(maximumLength(s))

s = "cccerrrecdcdccedecdcccddeeeddcdcddedccdceeedccecde"
print(maximumLength(s))

s = "cddedeedccedcedecdedcdeededdddcdddddcdeecdcddeecdc"
print(maximumLength(s)) 

s = "dcececccddceedddedeeddcecdeddddecceddeeedccdeeddcc"
print(maximumLength(s)) 